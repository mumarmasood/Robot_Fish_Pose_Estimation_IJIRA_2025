...
path = 'Sim_Data/v3/'
files_list = [
    'Sim_True_kp1_ki0.5_kd5_rc1_200filt.csv',
    'Sim_True_kp0.5_ki0.1_kd2_rc1_200filt.csv',
    'Sim_True_kp0.5_ki0.5_kd2_rc1_200filt.csv',
    'Sim_True_kp1_ki0.5_kd2_rc1_200filt.csv'
]
...
plt.xlabel(r'Time (s)')
plt.suptitle('PBVS Tracking Performance Across PID Gains')
